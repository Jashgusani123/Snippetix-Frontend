                ...
                <div className="bg-[#1f1f1fde] mb-10 rounded-2xl border-2 border-black shadow-2xl w-fit justify-center flex items-center py-12 px-6 mt-4">
                    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 text-white">
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-sm">What developers are saying about Snippetix.</p>
                            <div className="space-y-4 text-sm text-gray-300">
                                <div className="bg-zinc-800 p-3 rounded-lg border border-zinc-700">
                                    💬 “I stopped saving code in Notion. Snippetix is cleaner and way faster!”<br />
                                    <span className="text-xs text-gray-400">— Rohan, Frontend Developer</span>
                                </div>
                                <div className="bg-zinc-800 p-3 rounded-lg border border-zinc-700">
                                    💬 “I love that I can ask doubts on any snippet. It's like Stack Overflow + Gist.”<br />
                                    <span className="text-xs text-gray-400">— Ayesha, MERN Stack Dev</span>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-sm">Works well with your favorite tools and platforms.</p>
                            <ul className="space-y-2 text-base text-gray-300">
                                <li>🤖 <strong>OpenAI API</strong> — Smart code explanation</li>
                                <li>🌐 <strong>Google Search</strong> — Related YouTube + Docs content</li>
                            </ul>
                        </motion.div>
