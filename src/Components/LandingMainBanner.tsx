        ...
        <>
            <div className="flex flex-1 flex-col items-center justify-center px-4">
                ...
                <p className="text-lg text-gray-400 mt-4 text-center max-w-xl">
                    A modern platform to search, share, and solve code problems -- with the developer community.
                </p>
                {/* Code Banner */}
                <div className="banner flex bg-black rounded-2xl p-4 justify-around mt-10 mb-10">

                    <div className="text-left space-y-3 max-w-md">
                        <p className="text-lg text-gray-300 bg-zinc-900 rounded-md w-full">👋 Welcome to, <span className='font-bold'>Snippetix</span> </p>
                        <h3 className="text-2xl font-bold text-white">Code meets clarity. Learn, explain, and evolve.</h3>
                    ...
                    >
                        {/* Window dots */}
                        <div className="flex gap-2 absolute top-3 left-3 bg-bla">
                        ...
                        <pre className="text-sm font-mono whitespace-pre-wrap mt-8">
                            <code>
                                ...
                                <span className="text-pink-500">greet</span>
                                (name) {"{"}
                                {"\n  "}
