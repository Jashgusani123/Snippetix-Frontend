...
const LandingMainNavbar = () => {
    return (
        <>
            <div className="flex sticky top-0 bg-[#00000063] shadow-2xl rounded-2xl justify-between items-center h-20 px-10">
                <div className="flex items-center gap-2">
                    <img src="/Logo.png" alt="Snippetix Logo" className="w-10 h-10" />
                    <h1 className="text-2xl font-bold">Snippetix</h1>
                </div>
                <div>
